...
<head>
<meta charset="utf-8"/>
<title>Website Guru</title>
<meta content="width=device-width, initial-scale=1, maximum-scale=5" name="viewport"/>
<meta content="This is meta description" name="description"/>
<meta content="Themefisher" name="author"/>
<link href="{{ asset('front/assets/images/favicon.png') }}" rel="shortcut icon" type="image/x-icon"/>
<link href="{{ asset('front/assets/images/favicon.png') }}" rel="icon" type="image/x-icon"/>
<!-- # Google Fonts -->
...
<link href="{{ asset('front/assets/plugins/font-awesome/fontawesome.min.css') }}" rel="stylesheet"/>
<link href="{{ asset('front/assets/plugins/font-awesome/brands.css') }}" rel="stylesheet"/>
<link href="{{ asset('front/assets/plugins/font-awesome/solid.css') }}" rel="stylesheet"/>
<!-- # Main Style Sheet -->
...
<!-- /navigation -->
<div aria-hidden="true" aria-labelledby="applyLoanLabel" class="modal applyLoanModal fade" id="applyLoan" tabindex="-1">
...
<label class="form-label" for="loan_amount">Amount</label>
<input class="form-control shadow-none" id="loan_amount" placeholder="ex: 25000" type="number"/>
</div>
</div>
<div class="col-lg-6 mb-4 pb-2">
<div class="form-group">
<label class="form-label" for="loan_how_long_for">How long for?</label>
<input class="form-control shadow-none" id="loan_how_long_for" placeholder="ex: 12" type="number"/>
</div>
</div>
<div class="col-lg-12 mb-4 pb-2">
<div class="form-group">
<label class="form-label" for="loan_repayment">Repayment</label>
<input class="form-control shadow-none" disabled="" id="loan_repayment" type="number"/>
</div>
</div>
<div class="col-lg-6 mb-4 pb-2">
<div class="form-group">
<label class="form-label" for="loan_full_name">Full Name</label>
<input class="form-control shadow-none" id="loan_full_name" type="text"/>
</div>
</div>
<div class="col-lg-6 mb-4 pb-2">
<div class="form-group">
<label class="form-label" for="loan_email_address">Email address</label>
<input class="form-control shadow-none" id="loan_email_address" type="email"/>
</div>
</div>
<div class="col-lg-12">
<button class="btn btn-primary w-100" type="submit">Get Your Loan Now</button>
</div>
</div>
</form>
</div>
...
<p class="mb-4">Hallo Selamat Datangg....;)</p> <a class="btn btn-primary" data-bs-target="#applyLoan" data-bs-toggle="modal" href="#" type="button">See More<span class="ms-2 fas fa-arrow-right" style="font-size: 14px;"></span></a>
</div>
</div>
<div class="col-lg-6">
...
<svg class="shape shape-left text-light" fill="none" viewbox="0 0 192 752" xmlns="http://www.w3.org/2000/svg">
...
<svg class="shape shape-right text-light" fill="none" viewbox="0 0 731 746" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="card shadow-sm p-3">
              ...
              <p><strong>Mata Pelajaran:</strong><br>
                @foreach ($guru->mapels as $mapel)
                  <span class="badge bg-info text-dark">{{ $mapel->nama }}</span>
                @endforeach
              </p>
            </div>
          </div>
